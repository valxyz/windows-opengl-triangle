...
const char *fragmentShaderSource = "#version 330 core\n"
    ...
    "   FragColor = vec4(coord.x, coord.y, 0.5f, 1.0f);\n"
    "}\n\0";
...
int main(){
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        //pass window resolution to the shader
        glUniform2f(resolutionLocation, SCR_WIDTH, SCR_HEIGHT);
        ...
        glDrawArrays(GL_TRIANGLES, 0, 3); // draw only 3 vertices (1 triangle)
